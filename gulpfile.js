(() => {
  ...
  const browserSync = require("browser-sync"),
    ...
    bsConfig = require("gulp-bootstrap-configurator"); //bs3
  ...
  const makeBootstrapCss = () => {
    return gulp
      .src(path.src.sass + "/compiled/b3/config.json")
      .pipe(
        bsConfig.css({
          //   compress: true
        })
  ...
  const bootstrap = gulp.series(makeBootstrapCss, makeBootstrapJs);
