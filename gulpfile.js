...
gulp.task('make-bootstrap-css', function(){
  return gulp.src(path.src.sass + '/compiled/b3/config.json')
    .pipe(bsConfig.css({
    //   compress: true
  }))
...
gulp.task('watch', ['browser-sync', 'bs-upd', 'fonts', 'just-img', 'styles-libs-dev', 'styles-dev', 'scripts-libs', 'scripts-dev', 'sprite-svg-upd', 'sprite-img-upd', 'pug-upd'], function() {
...
gulp.task('watch-php', ['php-server', 'bs-upd', 'fonts', 'just-img', 'styles-libs-dev', 'styles-dev', 'scripts-libs', 'scripts-dev', 'sprite-svg-upd', 'sprite-img-upd', 'pug-upd'], function() {
    gulp.watch(path.src.sass + '/**/*.sass', ['styles-dev']);
    gulp.watch(path.src.spritesAss + '/svg/**/*.svg', ['sprite-svg-upd']);
    gulp.watch(path.src.spritesAss + '/img/**/*.png', ['sprite-img-upd']);
    gulp.watch(path.src.pug + '/**/*.pug', ['pug-upd']);
...
gulp.task('build', ['clean', 'bs-upd', 'fonts', 'just-img', 'styles-libs-build', 'styles-build', 'scripts-libs', 'scripts-build', 'sprite-svg-upd', 'pug-upd'], function() {
